...
class cetak_hak_kewajiban extends OPPController {
	...
	function cetak($id) {
		...
		<table width="100%" cellspacing="0" cellpadding="3" border="1">
			...
			<tr>
				<td colspan="3"><br><br> <span style="font-size: 12px;">Simpanan</span> </td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3"><br><br> <span style="font-size: 12px;">Pinjaman</span> </td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="h_kanan"><strong></strong></td>
			</tr>
