...
class cetak_pengajuan_1 extends OPPController {
	...
	function cetak($id) {
		...
		$html .='<div class="h_tengah"><strong>Bukti Analisa Pinjaman </strong> <br> Ref. '.date('Ymd_His').'</div>
...
<table width="100%" cellspacing="0" cellpadding="3" border="1">
			<tr>
				<td colspan="3"><br><br> <span style="font-size: 12px;">Simpanan Sukarela Yang Harus Ada</span> </td>
			</tr>
			
			<tr>
				<td>Pinjaman Paket</td>
				<td>:</td>
				<td></td>
			</tr>
			...
			<tr>
				<td>approve pinjaman</td>
				<td>:</td>
				<td></td>
			</tr>

			<tr>
				<td>S. Sukarela Yang Harus Tersimpan</td>
				<td>:</td>
				<td></td>
			</tr>

			<tr>
				<td>S. SUKARELA RUTIN</td>
				<td>:</td>
				<td></td>
			</tr>

			<tr>
				<td>S. SUKARELA YG Sudah Ada</td>
				<td>:</td>
				<td></td>
			</tr>

			<tr>
				<td>Tambahan Simpana Sukarela</td>
				<td>:</td>
				<td></td>
			</tr>
			 </table>
<table width="100%" cellspacing="0" cellpadding="3" border="1">
			<tr>
				<td colspan="3"><br><br> <span style="font-size: 12px;">Sisa Masa Kerja</span> </td>
			</tr>
...
<table width="100%" cellspacing="0" cellpadding="3" border="1">
			<tr>
				<td colspan="3"><br><br> <span style="font-size: 12px;">Kesimpulan Rekomendasi</span> </td>
			</tr>
			...
			<tr>
				<td>Pelunasan Pinjaman Rek</td>
				<td>:</td>
				<td></td>
			</tr>

			<tr>
				<td>Penalty Pinjaman</td>
				<td>:</td>
				<td></td>
			</tr>

			<tr>
				<td>Biaya Premi Asuransi</td>
				<td>:</td>
				<td></td>
			</tr>

			<tr>
				<td>Biaya Adminsitrasi & Materai</td>
				<td>:</td>
				<td></td>
			</tr>

			<tr>
				<td>TAMBAHAN SIMPANAN SUKARELA</td>
				<td>:</td>
				<td></td>
			</tr>
 </table>
<table width="100%" cellspacing="0" cellpadding="3" border="1">
			<tr>
				<td colspan="3"><br><br> <span style="font-size: 12px;">Total Yang Dibayar</span> </td>
			</tr>
			
			<tr>
				<td>Total Yang Di Bayarkan</td>
				<td>:</td>
				<td></td>
			</tr>
...
<table width="100%" cellspacing="0" cellpadding="3" border="1">
			<tr>
				<td colspan="3"><br><br> <span style="font-size: 12px;">Hasil Perhitungan</span> </td>
			</tr>
