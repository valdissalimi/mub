...
<script type="text/javascript">
	...
	function aksi_ft(value, row, index) {
		...
		nsi_out += ' <a href="<?php echo site_url('cetak_hak_kewajiban/cetak');?>/'+row.id+'" target="_blank" class="btn btn-sm bg-purple"><i class="fa fa-print"></i> Cetak Hak & Kewajiban</a>';
		nsi_out += ' <a href="<?php echo site_url('cetak_pengajuan_1/cetak');?>/'+row.id+'" target="_blank" class="btn btn-sm bg-purple"><i class="fa fa-print"></i> Bukti Analisa Pinjaman</a>';
